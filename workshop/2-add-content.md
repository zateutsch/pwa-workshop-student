...
Next, let's make the Repose app 👉🏼 [secure](3-deploy-to-Azure.md), [installable](4-add-web-manifest.md), [network-independent, and work offline](5-register-service-worker.md)!
